...
const pageSubtexts: Record<string, string> = {
  ...
  "/dashboard/terminals": "Manage your payment terminals",
...
export function GlobalUI({ 
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 md:left-64 right-0 z-50 border-t border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      {pageSubtext && (
        <div className="fixed top-[120px] left-0 md:left-64 right-0 z-40 border-b border-border/50 bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/50">
