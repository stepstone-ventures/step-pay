...
const RollingText = React.forwardRef<HTMLSpanElement, RollingTextProps>(function RollingText(
  {
    text,
    inView = false,
    inViewMargin = "0px",
  ...
  const repeatTransition = loop
    ? ({ repeat: Infinity, repeatType: "loop" as const, repeatDelay: loopDelay } as const)
    : {}
