...
const FireworksBackground = React.forwardRef<HTMLDivElement, FireworksBackgroundProps>(function FireworksBackground(
  {
    className,
    canvasProps,
    population = 1,
  ...
  React.useEffect(() => {
    ...
    const fallbackColor = dark ? ["#ffffff", "#f1f5f9", "#e2e8f0"] : ["#000000", "#111111", "#222222"];
    ...
    const launchFirework = () => {
      ...
      const fireworkColor = getColor(effectiveColor);
      ...
      const id = window.setTimeout(launchFirework, timeout);
      timeoutIds.push(id);
    };
  ...
  }, [population, color, fireworkSpeed, fireworkSize, particleSpeed, particleSize, dark]);
